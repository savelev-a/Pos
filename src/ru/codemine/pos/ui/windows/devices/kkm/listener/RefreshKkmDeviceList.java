...
@Component
public class RefreshKkmDeviceList implements ActionListener
{
    ...
    {
        List<KkmDevice> devices = kkmService.getAllKkmDevices();
        window.getTableModel().setKkmDevices(devices);
