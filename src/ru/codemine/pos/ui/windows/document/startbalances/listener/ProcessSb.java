...
@Component
public class ProcessSb implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(sb != null)
        {
            if(sb.isProcessed())
            {
                WebOptionPane.showMessageDialog(window, "Этот документ уже проведен", "Ошибка", WebOptionPane.WARNING_MESSAGE);
                return;
            }
            
            try
            {
                sbservice.process(sb);
            } 
