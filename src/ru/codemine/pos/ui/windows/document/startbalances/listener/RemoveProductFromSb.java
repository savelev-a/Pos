...
@Component
public class RemoveProductFromSb implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(row == -1)
        {
            WebOptionPane.showMessageDialog(window, "Не выбрана позиция для удаления", "Ошибка", WebOptionPane.WARNING_MESSAGE);
            return;
        }
        window.getTableModel().deleteRow(window.getTable().getSelectedRow());
